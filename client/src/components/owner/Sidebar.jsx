...
const Sidebar = () => {
  ...
  return (
    <div className="w-[220px] min-h-screen flex flex-col items-center pt-8 border-r border-borderColor text-sm">
      <div className="group relative">
        <label htmlFor="image">
          <img
            ...
            alt="profile"
            className="rounded-full h-9 w-9 md:w-14 md:h-14 mx-auto"
          />
          <input
            type="file"
            id="image"
        ...
        {image && (
          <button
            className="absolute -bottom-3 right-0 flex items-center gap-1 px-2 py-1 bg-primary/10 text-primary rounded text-xs"
            onClick={updateImage}
          >
            Save
