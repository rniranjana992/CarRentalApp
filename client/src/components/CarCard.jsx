...
const CarCard = ({car}) => {
  ...
  return (
    ...
    className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 translate-all duration-500 cursor-pointer'>
      <div className='relative h-48 overflow-hodden'>
